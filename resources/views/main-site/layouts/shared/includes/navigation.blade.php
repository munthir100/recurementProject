    ...
    <div class="container-fluid">
        <div class="col-auto col-lg-2 me-lg-0 me-auto">
            <a class="navbar-brand" href="demo-accounting.html">
                <img src="/images/custom/rayak-1.webp" data-at2x="/images/custom/rayak-1.webp" alt="" class="default-logo">
                <img src="/images/custom/rayak-1.webp" data-at2x="/images/custom/rayak-1.webp" alt="" class="alt-logo">
                <img src="/images/custom/rayak-1.webp" data-at2x="/images/custom/rayak-1.webp" alt="" class="mobile-logo">
            </a>
        </div>
        ...
        <div class="col-auto col-lg-2 text-end d-none d-sm-flex">
            <div class="header-icon">
                <div class="header-button">
                    <a href="#" class="btn btn-small btn-rounded btn-base-color btn-box-shadow">Log In</a>
                </div>
            </div>
        </div>
    </div>
