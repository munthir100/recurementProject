                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <div class="edit">
                                            <a href="{{ route('user.dashboard.offices.edit', $office->id) }}" class="btn btn-sm btn-success edit-item-btn" data-bs-target="#showModal">{{ __("Edit") }}</a>
                                        </div>
                                        <div class="remove">
                                            <button class="btn btn-sm btn-danger remove-item-btn" data-id="{{ $office->id }}">{{ __("Delete") }}</button>
                                        </div>
                                    </div>
                                </td>
                            </tr>
